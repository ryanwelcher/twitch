 ...
 */
function create_block_display_meta_block_init() {
	register_block_type(
		__DIR__ . '/build',
		array(
			'render_callback' => 'create_block_display_meta_render_callback',
		)
	);
}
add_action( 'init', 'create_block_display_meta_block_init' );
