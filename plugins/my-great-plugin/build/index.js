...
const Edit = props => {
  ...
  const isResolving = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    return select('core/data').isResolving('core', 'getEntityRecords', ['postType', 'post', // { per_page: parseInt( numberOfPosts ) },
    {
      per_page: 10
    }]);
  });
  ...
  const reQuery = () => {
    invalidateResolution('core', 'getEntityRecords', ['postType', 'post', // { per_page: parseInt( numberOfPosts ) },
    {
      per_page: 10
    }]);
  };
  ...
  if (isResolving) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", blockProps, parseInt(numberOfPosts), ".");
  }
