...
const App = _ref => {
  ...
  const {
    data,
    error
  } = (0,swr__WEBPACK_IMPORTED_MODULE_2__["default"])("https://api.imgflip.com/get_memes", fetcher);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, `${message} | Ratio: ${ratio}`, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), counter, (data === null || data === void 0 ? void 0 : (_data$data = data.data) === null || _data$data === void 0 ? void 0 : _data$data.memes) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: data === null || data === void 0 ? void 0 : (_data$data2 = data.data) === null || _data$data2 === void 0 ? void 0 : _data$data2.memes[0].url,
    width: "300"
  }));
};
...
_wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  ...
  const observer = new IntersectionObserver(function (entries) {
    if (entries[0]["isIntersecting"] === true) {
      let message = "";
      if (entries[0]["intersectionRatio"] === 1) message = "Target is fully visible in the screen";else if (entries[0]["intersectionRatio"] > 0.5) message = "More than 50% of target is visible in the screen";else message = "Less than 50% of target is visible in the screen"; // change the opacity?
      ...
      (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.unmountComponentAtNode)(container);
    }
  }, {
